        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th> idPqr<span class="icon-arrow">&UpArrow;</span></th>
            ...
            <tbody>
                <tr>
                    <td>{{$devoluciones->id}} </td>
                    <td>{{$devoluciones->motivo}}</td>
                    <td>{{$devoluciones->idPedido}}</td>
                    <td>{{$devoluciones->idPqr}}</td>
                   
                    <td>
                     <a href="{{route('devoluciones.create')}}"><p class="status delivered">Agregar </p></a>
                    </td>
